...
#DAEMONS+=('com.apple.remotepairtool') #Pairing devcices remotely
...
DAEMONS+=('com.apple.apsd') #Apple Push Notification Service (apsd) - it's calling home quite often
...
AGENTS+=('com.apple.imagent') #Listens for FaceTime invitations
AGENTS+=('com.apple.cloudfamilyrestrictionsd-mac') #iCloud Family restrictions
AGENTS+=('com.apple.cloudpaird') #Propably syncing your photos to icloud
...
AGENTS+=('com.apple.rtcreportingd') #Related to Home Sharing, most likely it checks if device is auth for home sharing
